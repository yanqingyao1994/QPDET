...
class OBBRPNHeadXYRAB(RPNTestMixin, OBBAnchorHead):
    """RPN head.
    ...
    def __init__(self, in_channels, **kwargs):
        super(OBBRPNHeadXYRAB, self).__init__(
            1, 
            in_channels, 
            bbox_type='obb',
            reg_dim=5,
    ...
    def loss(self,
        ...
        """
        losses = super(OBBRPNHeadXYRAB, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
    ...
    def _get_bboxes_single(self,
        ...
        xyrab = self.bbox_coder.xyrab(anchors, rpn_bbox_pred)
        ...
        dets = torch.cat([proposals, scores[:, None], xyrab], dim=1)
        dets = dets[keep]
