...
class CLM(nn.Module):
    ...
    def get_anchor_single(self, points, shape_pred, theta_pred, base_len):
        ...
        r_x_offset = shape_pred[:, 2] - shape_pred[:, 0]
        r_y_offset = shape_pred[:, 3] - shape_pred[:, 1]
...
class AOPGOBBNMSHead(OBBAnchorHead, RPNTestMixin):
    ...
    def _get_bboxes_single(self,
        ...
        nms_cfg = dict(type='obb_nms', iou_thr=cfg.nms_thr)
        dets, keep = arb_batched_nms(proposals, scores, ids, nms_cfg)
